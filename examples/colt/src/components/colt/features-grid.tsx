  ...
  const defaultFeatures = [
    {
      ...
      description: "First data centres were built in 1999 and Hyperscale operations started in 2016",
    },
    {
      icon: "🌍",
    ...
    },
    {
      ...
      description: "Adaptable design: air, hybrid and water cooling. Multi-hall and multi-building scalability",
    },
  ]
