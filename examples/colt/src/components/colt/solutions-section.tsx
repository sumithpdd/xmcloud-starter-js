...
export const SolutionsSection = (props: SolutionsSectionProps): JSX.Element => {
  ...
  const defaultSolutions = [
    {
      image: { value: { src: "https://www.coltdatacentres.net/-/media/Images/carousel-images/caro-portal-login.jpg" } },
      title: { value: "Existing customers: Manage your account" },
      description: { value: "Access your account to raise tickets, manage access to your location and more." },
      link: { value: { href: "https://customerportal.coltdatacentres.net/CherwellPortal" } },
      linkText: { value: "Login now" },
    },
    {
      image: { value: { src: "https://www.coltdatacentres.net/-/media/Images/carousel-images/car-hyperscale.jpg" } },
    ...
    {
      image: { value: { src: "https://www.coltdatacentres.net/-/media/Images/carousel-images/car-colocation.jpg" } },
              ...
              <div key={index} className="flex-[0_0_100%] md:flex-[0_0_45%] lg:flex-[0_0_30%] min-w-0">
                <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4 leading-relaxed">{solution.description.value}</p>
                    <a href={solution.link.value?.href || "#"} className="text-[#00BFA5] font-semibold hover:underline">
