...
import type { ComponentProps, TextField, ImageField, LinkField } from "@sitecore-content-sdk/nextjs"
...
export const SolutionsCarousel = (props: SolutionsCarouselProps): JSX.Element => {
  ...
  const defaultCards = [
    ...
    },
    {
      ...
      description: "Our colocation solutions provide secure, resilient infrastructure with flexible capacity options.",
      ctaText: "Learn more",
              ...
              >
                <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="text-xl font-bold mb-3 text-gray-900">{card.fields?.title?.value || card.title}</h3>
